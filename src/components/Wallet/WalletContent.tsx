...
const WalletContent:React.FC = () => {
  ...
  const { isOpen: isImportWalletOpen, onOpen: onImportWalletOpen, onClose: onImportWalletClose } = useDisclosure();
  ...
  return (
    <div className="px-8 py-4 w-full flex flex-col">
      ...
      <div className="w-full">
        <WalletList wallets={wallets} handleReload={() => setReload((prev) => !prev)}/>
      </div>
